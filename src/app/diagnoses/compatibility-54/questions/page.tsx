...
const STORAGE_KEY_USER = "compatibility-54-answers-user";
const STORAGE_KEY_PARTNER = "compatibility-54-answers-partner";
      ...
      <div className="mx-auto w-full max-w-3xl">
        ...
        <div className="mb-8 sticky top-0 bg-white z-10 pt-4 pb-4 border-b border-[#2C3E50]/10">
          ...
          <div className="h-2 w-full overflow-hidden rounded-full bg-[#2C3E50]/10">
            <div
              className="h-full rounded-full bg-gradient-to-r from-[#2C3E50] to-[#34495E] transition-all duration-500 ease-out"
                      ...
                      <button
                        ...
                        className={`w-full rounded-lg border-2 px-4 py-3 text-left transition-all duration-200 ${
                          isSelected
                            ...
                            : "border-[#2C3E50]/20 bg-white text-[#2C3E50] hover:border-[#2C3E50] hover:bg-[#2C3E50]/5"
                        }`}
                      >
